%define distversion %( perl -e 'Creating /home/mkulke/Development/fedge-0.1/fedge.spec...=\<\>;/(\d+)\.(\d)\.?(\d)?/; print "".(||0)' /etc/*-release)
Name: fedge
Summary: fedge -- Some description
Version: 0.1
Release: %{_vendor}_%{distversion}
Copyright: GPL
Group: X11/KDE/Utilities
Source: ftp://ftp.kde.org/pub/kde/unstable/apps/utils/%{name}-%{version}.tar.gz
Packager: mkulke <magnus.kulke@radicalapproach.de>
